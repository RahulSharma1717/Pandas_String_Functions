# Display the movies of drama genre.

import pandas as pd

df = pd.read_csv('IMDB Top 250 Movies.csv')
pd.set_option('display.max_columns', None)
drama_movies = df[df['genre'].str.lower().str.contains('drama')]
print(drama_movies)
...
..                                                 ...                   ...   
242  Bibi Andersson,Liv Ullmann,Margaretha Krook,Gu...        Ingmar Bergman   
245  Viola Davis,Emma Stone,Octavia Spencer,Bryce D...           Tate Taylor   
246  Maksim Munzuk,Yuriy Solomin,Mikhail Bychkov,Vl...        Akira Kurosawa   
248  Ben Kingsley,John Gielgud,Rohini Hattangadi,Ro...  Richard Attenborough   
249  Kevin Costner,Mary McDonnell,Graham Greene,Rod...         Kevin Costner   
