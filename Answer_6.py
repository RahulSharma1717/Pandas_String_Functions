# Find out the number of writers in each movie.
...
df['num_of_writers'] = df['writers'].apply(lambda x: len(str(x).split(',')))
print(df)
...
249             Kevin Costner   
                                             ...
                                             writers  num_of_writers  
0                        Stephen King,Frank Darabont               2  
1                    Mario Puzo,Francis Ford Coppola               2  
2    Jonathan Nolan,Christopher Nolan,David S. Goyer               3  
3                    Francis Ford Coppola,Mario Puzo               2  
4                                      Reginald Rose               1  
..                                               ...             ...  
245                     Tate Taylor,Kathryn Stockett               2  
246    Akira Kurosawa,Yuriy Nagibin,Vladimir Arsenev               3  
247             Ron Clements,John Musker,Ted Elliott               3  
248                                      John Briley               1  
249                                    Michael Blake               1  
